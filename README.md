...
TabHaven is **not yet available on the Chrome Web Store**. To install locally:
...
4. Click **Load unpacked** and select the folder where you cloned TabHaven.  
5. Use the extension to save and restore your workspaces.
